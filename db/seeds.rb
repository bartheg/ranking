...
DefaultLadderConfig.create(default_ranking: 1500, max_distance_between_players: 10, min_points_to_gain: 10, disproportion_factor: 10, unexpected_result_bonus: 50, hours_to_confirm: 49)
