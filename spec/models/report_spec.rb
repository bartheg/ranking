...
RSpec.describe Report, type: :model do
  ...
  describe '#original_report' do
    ...
    before(:context) do
      ...
      @config = DefaultLadderConfig.create!(default_ranking: 1500, max_distance_between_players: 10, loot_constant: 10, disproportion_factor: 10, unexpected_result_bonus: 50, hours_to_confirm: 49, ladder_id: @ladder.id)
    end
